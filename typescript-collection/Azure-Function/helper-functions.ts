...
export function getStorageConnectionString(resourceGroupName: pulumi.Input<string>, accountName: pulumi.Input<string>): pulumi.Output<string>{
    const primaryStorageKey = getPrimaryStorageKey(resourceGroupName, accountName)

    return pulumi.interpolate`DefaultEndpointsProtocol=https;AccountName=${accountName};AccountKey=${primaryStorageKey}`;
}

function getPrimaryStorageKey(resourceGroupName: pulumi.Input<string>, accountName: pulumi.Input<string>): pulumi.Output<string>{
